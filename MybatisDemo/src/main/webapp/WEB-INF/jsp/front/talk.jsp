...
<head>
    ...
    <script type="text/javascript" src="<%= basePath %>resources/js/jquery.mousewheel.js"></script>
    <!-- the jScrollPane script -->
    <script type="text/javascript" src="<%= basePath %>resources/js/jquery.jscrollpane.min.js"></script>
    <script type="text/javascript" src="<%= basePath %>resources/js/scroll-startstop.events.jquery.js"></script>
    <!--讨论区滚动条end-->
