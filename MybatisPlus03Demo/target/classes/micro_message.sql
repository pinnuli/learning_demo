/*
 ...
 Source Schema         : micro_message

 Target Server Type    : MySQL
 Target Server Version : 50723
 File Encoding         : 65001

 Date: 20/08/2018 23:18:35
*/
...
-- Records of command
-- ----------------------------
INSERT INTO `command` VALUES (1, '娱乐', '好玩');
...
-- ----------------------------
INSERT INTO `command_content` VALUES (1, '如果你的月薪是3000块钱，请记得分成五份，一份用来买书，一份给家人，一份给女朋友买化妆品和衣服，一份请朋友们吃饭，一份作为同事的各种婚丧嫁娶的份子钱。剩下的2999块钱藏起来，不要告诉任何人', 1);
INSERT INTO `command_content` VALUES (2, '昨日，邓超在微博分享了自己和孙俪的书法。夫妻同样写幸福，但差距很大。邓超自己都忍不住感慨字丑：左边媳妇写的。右边是我写的。看完我再也不幸福了。', 1);
...
CREATE TABLE `message`  (
  ...
  `COMMAND` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '指令名称',
